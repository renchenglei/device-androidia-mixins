...
PRODUCT_COPY_FILES += $(LOCAL_PATH)/input-port-associations.xml:vendor/etc/input-port-associations.xml
...
PRODUCT_COPY_FILES += device/intel/civ/host/vm-manager/scripts/lg_vinput-manager:$(PRODUCT_OUT)/scripts/lg_vinput-manager
